...
class ElasticsearchClusterPlanInfo(object):
    """
    ...
    def __init__(self, plan_attempt_id=None, plan_attempt_name=None, healthy=None, attempt_start_time=None, attempt_end_time=None, plan_end_time=None, plan=None, plan_attempt_log=None, source=None):
        """
        ElasticsearchClusterPlanInfo - a model defined in Swagger
        """
    ...
    def plan_attempt_id(self):
        """
        Gets the plan_attempt_id of this ElasticsearchClusterPlanInfo.
        A UUID for each plan attempt

        :return: The plan_attempt_id of this ElasticsearchClusterPlanInfo.
        :rtype: str
        """
    ...
    def plan_attempt_id(self, plan_attempt_id):
        """
        Sets the plan_attempt_id of this ElasticsearchClusterPlanInfo.
        A UUID for each plan attempt

        :param plan_attempt_id: The plan_attempt_id of this ElasticsearchClusterPlanInfo.
        :type: str
        """
    ...
    def plan_attempt_name(self):
        """
        Gets the plan_attempt_name of this ElasticsearchClusterPlanInfo.
        A human readable name for each plan attempt, only populated when retrieving plan histories

        :return: The plan_attempt_name of this ElasticsearchClusterPlanInfo.
        :rtype: str
        """
    ...
    def plan_attempt_name(self, plan_attempt_name):
        """
        Sets the plan_attempt_name of this ElasticsearchClusterPlanInfo.
        A human readable name for each plan attempt, only populated when retrieving plan histories

        :param plan_attempt_name: The plan_attempt_name of this ElasticsearchClusterPlanInfo.
        :type: str
        """
    ...
    def healthy(self):
        """
        Gets the healthy of this ElasticsearchClusterPlanInfo.
        Either the plan ended successfully, or is not yet completed (and no errors have occurred)

        :return: The healthy of this ElasticsearchClusterPlanInfo.
        :rtype: bool
        """
    ...
    def healthy(self, healthy):
        """
        Sets the healthy of this ElasticsearchClusterPlanInfo.
        Either the plan ended successfully, or is not yet completed (and no errors have occurred)

        :param healthy: The healthy of this ElasticsearchClusterPlanInfo.
        :type: bool
        """
        if healthy is None:
    ...
    def attempt_start_time(self):
        """
        Gets the attempt_start_time of this ElasticsearchClusterPlanInfo.
        When this plan attempt (ie to apply the plan to the cluster) started (ISO format in UTC)

        :return: The attempt_start_time of this ElasticsearchClusterPlanInfo.
        :rtype: datetime
        """
    ...
    def attempt_start_time(self, attempt_start_time):
        """
        Sets the attempt_start_time of this ElasticsearchClusterPlanInfo.
        When this plan attempt (ie to apply the plan to the cluster) started (ISO format in UTC)

        :param attempt_start_time: The attempt_start_time of this ElasticsearchClusterPlanInfo.
        :type: datetime
        """
    ...
    def attempt_end_time(self):
        """
        Gets the attempt_end_time of this ElasticsearchClusterPlanInfo.
        If this plan completed or failed (ie is not pending), when the attempt ended (ISO format in UTC)

        :return: The attempt_end_time of this ElasticsearchClusterPlanInfo.
        :rtype: datetime
        """
    ...
    def attempt_end_time(self, attempt_end_time):
        """
        Sets the attempt_end_time of this ElasticsearchClusterPlanInfo.
        If this plan completed or failed (ie is not pending), when the attempt ended (ISO format in UTC)

        :param attempt_end_time: The attempt_end_time of this ElasticsearchClusterPlanInfo.
        :type: datetime
        """
    ...
    def plan_end_time(self):
        """
        Gets the plan_end_time of this ElasticsearchClusterPlanInfo.
        If this plan is not current or pending, when the plan was no longer active (ISO format in UTC)

        :return: The plan_end_time of this ElasticsearchClusterPlanInfo.
        :rtype: datetime
        """
    ...
    def plan_end_time(self, plan_end_time):
        """
        Sets the plan_end_time of this ElasticsearchClusterPlanInfo.
        If this plan is not current or pending, when the plan was no longer active (ISO format in UTC)

        :param plan_end_time: The plan_end_time of this ElasticsearchClusterPlanInfo.
        :type: datetime
        """
    ...
    def plan(self):
        """
        Gets the plan of this ElasticsearchClusterPlanInfo.

        :return: The plan of this ElasticsearchClusterPlanInfo.
    ...
    def plan(self, plan):
        """
        Sets the plan of this ElasticsearchClusterPlanInfo.

        :param plan: The plan of this ElasticsearchClusterPlanInfo.
    ...
    def plan_attempt_log(self):
        """
        Gets the plan_attempt_log of this ElasticsearchClusterPlanInfo.

        :return: The plan_attempt_log of this ElasticsearchClusterPlanInfo.
    ...
    def plan_attempt_log(self, plan_attempt_log):
        """
        Sets the plan_attempt_log of this ElasticsearchClusterPlanInfo.

        :param plan_attempt_log: The plan_attempt_log of this ElasticsearchClusterPlanInfo.
    ...
    def source(self):
        """
        Gets the source of this ElasticsearchClusterPlanInfo.
        Information describing the source that facilitated the plans current state

        :return: The source of this ElasticsearchClusterPlanInfo.
    ...
    def source(self, source):
        """
        Sets the source of this ElasticsearchClusterPlanInfo.
        Information describing the source that facilitated the plans current state

        :param source: The source of this ElasticsearchClusterPlanInfo.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ElasticsearchClusterPlanInfo):
            return False
